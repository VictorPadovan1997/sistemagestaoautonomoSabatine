<?php
$this->extend('/Elements/indexCupoms');
...
$titulos = array(
    array($this->Paginator->sort('Cupom.numero_cupom', 'Cod. Cupom') => array('width' => '0%', 'class'=>"hint--bottom", 'aria-label'=>"Ordenar por Cupom")),
    array('Validade' => array('width' => '0%')),
    array($this->Paginator->sort('Cupom.situacao', 'Situação') => array('width' => '0%', 'class'=>"hint--bottom", 'aria-label'=>"Ordenar por Situacao")),
    array('Total Desconto' => array('width' => '0%')),
